...
public static class Setup
{
    ...
    public static UnityStringInvokeCriticalAnalyzer UnityStringInvokeCriticalAnalyzer(ObfuscationSettings obfuscation)
    {
        return new UnityStringInvokeCriticalAnalyzer(obfuscation);
    }
}

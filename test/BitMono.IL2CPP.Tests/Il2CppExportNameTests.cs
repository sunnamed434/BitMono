...
public class Il2CppExportNameTests
{
    ...
    public void Mangle_KnownAnswer_LocksTheNativeContract()
    {
        ...
        Il2CppExportName.Mangle(key, "il2cpp_init").ShouldBe("Z6f8fdaf3");
    }
    ...
    public void Mangle_DiffersPerKey()
    {
        ...
        Il2CppExportName.Mangle(keyA, "il2cpp_init").ShouldNotBe(Il2CppExportName.Mangle(keyB, "il2cpp_init"));
    }
}

...
- .NET 10.0: ``BitMono-v0.41.1+7aaeceac-CLI-net10.0-linux-x64.zip``
- .NET 9.0: ``BitMono-v0.41.1+7aaeceac-CLI-net9.0-linux-x64.zip``
- .NET 8.0: ``BitMono-v0.41.1+7aaeceac-CLI-net8.0-linux-x64.zip``
- .NET 7.0: ``BitMono-v0.41.1+7aaeceac-CLI-net7.0-win-x64.zip``
- .NET 6.0: ``BitMono-v0.41.1+7aaeceac-CLI-net6.0-linux-x64.zip``
- .NET 462: ``BitMono-v0.41.1+7aaeceac-CLI-net462-win-x64.zip``
- netstandard 2.1: ``BitMono-v0.41.1+7aaeceac-CLI-netstandard2.1-linux-x64.zip``
- netstandard 2.0: ``BitMono-v0.41.1+7aaeceac-CLI-netstandard2.0-win-x64.zip``

Archive naming explained:

- ``v0.41.1`` is the version

...
#pragma warning disable CS8618
    ...
    // Optional per-build key (32 hex chars) for --encrypt-metadata / --rename-il2cpp-exports; null = dev key.
    public string? EncryptMetadataKey { get; set; }
    // Set when the run is a standalone --rename-il2cpp-exports step instead of an obfuscation.
    public string? RenameExportsPath { get; set; }
